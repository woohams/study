		...
		<ul>
			<li>
				...
				<input type="hidden" name="cal_url" value="<c:url value='/sym/cal/EgovNormalCalPopup.do'/>" />
                  ...
                  <input type="text" name="fDate" size="11" readonly="readonly" title="<spring:message code="comStsSst.scrinStats.fromDate" />" id="fDate" value="${statsInfo.fromDate}"/> <!-- 시작일자 -->
                  <input type="text" name="tDate" size="11" readonly="readonly" tabindex="2" title="<spring:message code="comStsSst.scrinStats.toDate" />" id="tDate" value="${statsInfo.toDate}"/> <!-- 종료일자 -->
