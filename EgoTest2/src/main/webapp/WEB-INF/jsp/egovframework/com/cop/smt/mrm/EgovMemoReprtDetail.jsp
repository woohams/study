...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<c:if test="${memoReprt.reprtSttus eq ('미확인' or  'Unidentified') && memoReprt.wrterId eq uniqId}">
			...
			<span class="btn_s"><a href="<c:url value='/cop/smt/mrm/deleteMemoReprt.do'/>?reprtId=<c:out value='${memoReprtVO.reprtId}'/>" onclick="fn_egov_delete_memoreprt(); return false;"><spring:message code="button.delete" /></a></span>
		</c:if>
