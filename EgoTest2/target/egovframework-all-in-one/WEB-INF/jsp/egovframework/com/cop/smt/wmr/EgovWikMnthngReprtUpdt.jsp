...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			<th><spring:message code="copSmtWmr.wikMnthngReprtUpdt.file"/></th><!-- 파일첨부 -->
			<td class="left">
			    <div id="file_upload_posbl"  style="display:none;" >
					...
					<input id="egovComFileUploader" type="file" name="file_1" id="egovfile_0" title="<spring:message code='copSmtWmr.wikMnthngReprtUpdt.file'/>" /> 
					</div>
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<input class="s_submit" type="submit" value='<spring:message code="button.save" />' onclick="fn_egov_update_wikmnthngreprt()" /><!-- 저장 -->
