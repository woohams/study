...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			<th><spring:message code="copSmtWmr.wikMnthngReprtRegist.file"/></th><!-- 파일첨부 -->
			<td class="left">
				<div class="egov_file_box">
				<label for="egovfile_0" id="file_label"><spring:message code="title.attachedFileSelect"/></label> 
				<input name="file_1" id="egovComFileUploader" type="file" title="<spring:message code="copSmtWmr.wikMnthngReprtRegist.file"/>"/> <span class="pilsu">
