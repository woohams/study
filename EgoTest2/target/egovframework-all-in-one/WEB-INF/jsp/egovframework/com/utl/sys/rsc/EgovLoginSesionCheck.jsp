...
<form:form commandName="loginSessionCheck" method="post" action="${pageContext.request.contextPath}/utl/sys/rsc/setLoginSession.do">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <label for="sessionUrl"><input name="sessionUrl" id="sessionUrl" value="<%=user.getUrl() %>" type="text" maxLength="1000" size="80" readonly="readonly" class="readOnlyClass"></label>
			</td>
		</tr>
	</table>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<%=user.getUrl() %>" onclick="" target=“_blank” title="새창" onclick="fncgetLoginSessionView('<%=user.getUrl() %>'); return false;"><spring:message code="utlSysRsc.loginSessionCheck.sessionView"/></a></span><!-- 이동 -->
	</div>
