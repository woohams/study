...
<form:form commandName="requestOfferVO" name="requestOfferVO" action="${pageContext.request.contextPath}/dam/spe/req/updtRequestOffer.do" method="post" enctype="multipart/form-data" >
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <input name="file_1" id="egovComFileUploader" type="file" title="<spring:message code="comDamSpeReq.comDamRequestOfferUpdt.atchFile"/>"/><!--파일첨부-->
...
<c:if test="${requestOfferVO.atchFileId eq '' or requestOfferVO.atchFileId == null}">
